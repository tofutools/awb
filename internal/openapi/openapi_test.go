...
func TestPathsCoverTheWholeAPI(t *testing.T) {
	...
	for _, path := range []string{
		...
		"/api/issues/{id}/release", "/api/issues/{id}/status", "/api/issues/{id}/reopen",
...
func TestOperations(t *testing.T) {
	...
	assert.ElementsMatch(t, []string{
		...
		"workspace", "parent", "parent-type", "recursive", "include-parent", "filter", "sort", "limit", "offset",
	}, names("listBlocked"))
	assert.ElementsMatch(t, []string{
		"q", "status", "include-closed", "include-archived", "type", "priority", "priority-max", "label",
		"assignee", "unassigned", "workspace", "parent", "parent-type", "recursive", "include-parent", "filter", "readiness", "limit", "offset",
	}, names("listLabels"))
	...
	assert.ElementsMatch(t, []string{
		...
		"selected-epic", "include-no-epic", "include-backlog", "column", "hidden-epic", "label", "assignee", "priority-max", "status", "epic",
	}, names("getBoard"))
