export type IconName = "attachment" | "blocked" | "boards" | "change" | "clock" | "edit" | "info" | "issues" | "workspaces" | "ready" | "relation" | "search" | "tag" | "users";
...
export function Icon({name}:{name:IconName}) {return <svg viewBox="0 0 24 24" aria-hidden="true" class="icon" dangerouslySetInnerHTML={{__html:paths[name]}}/>;}
